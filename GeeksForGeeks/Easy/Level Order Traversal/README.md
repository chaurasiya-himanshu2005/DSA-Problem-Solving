...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/level-order-traversal/1)

## Solved On
10 Sept 2026 at 02:34 pm

<h2><a href="https://www.geeksforgeeks.org/problems/level-order-traversal/1">Level Order Traversal</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 14pt;"><span style="font-size: 18px;">Given the <strong>root </strong>of a Binary Tree, your task is to return its&nbsp;</span><span style="font-size: 18px;">Level Order Traversal</span><span style="font-size: 18px;">.</span></span></p>
<p><strong><span style="font-size: 18.6667px;">Note:&nbsp;</span></strong><span style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; font-size: 14pt;">A level order traversal is a breadth-first search (BFS) of the tree. It visits nodes level by level, starting from the root, and processes all nodes from left to right within each level before moving to the next.</span></p>
...
<pre><span style="font-size: 14pt;"><strong>Input:</strong> root = [10, 20, 30, 40, 50, N, N]<br><img src="https://media.geeksforgeeks.org/img-practice/prod/addEditProblem/700511/Web/Other/blobid1_1758800199.webp" width="336" height="234">
