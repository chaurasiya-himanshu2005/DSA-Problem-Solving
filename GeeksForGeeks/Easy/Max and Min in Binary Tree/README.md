...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/max-and-min-element-in-binary-tree/1)

## Solved On
07 Sept 2026 at 11:41 am

<h2><a href="https://www.geeksforgeeks.org/problems/max-and-min-element-in-binary-tree/1">Max and Min in Binary Tree</a></h2><h3>Difficulty Level: Easy</h3><hr><p><span style="font-size: 18px;">Given the root of a Binary Tree, find the maximum and minimum element present in the tree.</span></p>
