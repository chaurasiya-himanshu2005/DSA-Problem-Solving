...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/infix-to-postfix-1587115620/1)

## Solved On
18 Sept 2026 at 08:55 am

<h2><a href="https://www.geeksforgeeks.org/problems/infix-to-postfix-1587115620/1">Infix to Postfix</a></h2><h3>Difficulty Level: Medium</h3><hr><p><span style="font-size: 14pt;">You are given a string <strong>s</strong> representing an <strong>infix expression</strong></span><span style="font-size: 14pt;">. Convert this infix expression to a postfix expression.</span></p>
<ul>
...
<p><span style="font-size: 14pt;"><strong style="font-size: 14pt;">Constraints:</strong><br><span style="font-size: 14pt;">1 ≤ s.length ≤ 5*10<sup>3</sup></span><br><span style="font-size: 18.6667px;">s[i] can be </span></span><span style="font-size: 18.6667px;">an operand (a–z, A–Z, 0–9), an operator (+, -, *, /, ^) or a parenthesis ((, ))</span></p>