...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/addition-of-two-square-matrices4916/1)

## Solved On
21 Sept 2026 at 11:06 pm

<h2><a href="https://www.geeksforgeeks.org/problems/addition-of-two-square-matrices4916/1">Add of 2 Square Matrices</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 14pt;">You are given two square matrices, a[][] and b[][], each of size n x n. Your task is to compute the sum of these two matrices and store the result in the matrix a[][] itself.</span></p>
