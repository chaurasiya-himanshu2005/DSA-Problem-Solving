...
## Problem Link
[View Problem](https://www.geeksforgeeks.org/problems/inorder-traversal/1)

## Solved On
10 Sept 2026 at 12:38 pm

<h2><a href="https://www.geeksforgeeks.org/problems/inorder-traversal/1">Inorder Traversal</a></h2><h3>Difficulty Level: Basic</h3><hr><p><span style="font-size: 18px;">Given a <strong> root </strong>of a Binary Tree, your task is to return its<strong> </strong>Inorder Traversal.</span></p>
<p><span style="font-size: 18px;"><span style="font-size: 18px;"><strong>Note: </strong>An inorder traversal first visits the left child (including its entire subtree), then visits the node, and finally visits the right child (including its entire subtree).</span></span></p>
